...
import com.uksf.updater.utility.Invokable;
...
import static com.uksf.updater.utility.Info.BORDER_STANDARD;
import static com.uksf.updater.utility.Info.COLOUR_TRANSPARENT;
...
public class CustomButton extends JPanel implements MouseListener {
    ...
    public void mouseClicked(MouseEvent e) {
        try {
			...
			LogHandler.log("Updater no such method: " + toCall);
