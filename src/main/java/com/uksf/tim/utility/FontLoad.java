...
public class FontLoad {
    ...
    public static void loadFonts() throws IOException, FontFormatException {
        ...
        FONT_STANDARD = Font.createFont(Font.TRUETYPE_FONT, new File("src\\main\\resources\\assets\\Fonts\\Bariol_Light.otf"));
        FONT_THIN = Font.createFont(Font.TRUETYPE_FONT, new File("src\\main\\resources\\assets\\Fonts\\Bariol_Light.otf"));
